...
void create(){seteuid(getuid());}//此时euid=uid="ROOT"

//me就是使用go指令的物件，比如游戏中输入go指令时me指的就是玩家。
//玩家物件，比如/clone/user/user#7027 ("普通百姓 张三李四(mudren)")
int main(object me, string arg)
{
    ...
    env = environment(me);//玩家所在房间物件，比如/d/city/kedian ("客店")
