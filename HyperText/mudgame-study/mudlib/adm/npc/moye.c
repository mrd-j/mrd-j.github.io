...
void create()
{
    ...
    check_clone();//编译（发生在目的地房间的come_here）此物件后，如果莫邪不是克隆体就会移动到/d/item/xiaowu
...
int do_show(string arg)
{
    ...
    value = power_point * 2 + 20;//这种物品打造道具需消耗多少黄金。
...
int accept_object(object me, object ob)
{
    ...
    if( ob->query("id") == "qiankun stone" )
    {
        filename = ITEM_DIR + "depot/" + me->query("id");//"/data/item/"
